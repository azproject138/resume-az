...
?> 
  ...
  <option value="pe">Pofessional Experience</option>
   ...
   <div class="form-group col-md-8">
    ...
    <input type="text" name="ogname" class="form-control" id="website" placeholder="Working at ETC Pvt. Ltd. , New York" required>
  </div>
   <div class="form-group col-md-4">
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <option value="pe" selected>Pofessional Experience</option>
   ...
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="ogname" value="<?=$data2['ogname']?>" class="form-control" id="website" placeholder="Working at ETC Pvt. Ltd. , New York" required>
  </div>
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
